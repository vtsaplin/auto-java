# Auto Java
Java is a great language but as nothing is perfect it also has a few limitations. On the other hand it offers some ways to overcome its own shortcomings. With source/byte code generation in place we can implement features which are only available in other languages such as traits, AOP and auto-generated bound properties.
